...
read, and detach over remote-bitbang JTAG. Remaining top-level work includes
software programming of OTP through the programming registers, end-to-end DMA
memory-copy through real slave contents, interrupt-driven software, longer SoC
boot tests from `llvm_s1` output, and richer debug operations such as
single-step, breakpoints, abstract memory access, and true core DPC capture.
