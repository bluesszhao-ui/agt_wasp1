...
| --- | --- | --- | --- |
| 0ns-21ns | Reset | Hold reset and check boot PC / invalid slots | Boot PC and invalid NOP slots matched |
...
| 115ns-125ns | Redirect | Flush slots and set redirect PC | Slots flushed and fetch PC redirected |
...
- Reset PC and invalid pipeline slots.
- Fetch acceptance and PC + 4 stepping.
- IF/ID to EX/WB advance.
- Fetch/decode stall hold.
- Execute bubble insertion.
- Redirect flush and PC overwrite.
