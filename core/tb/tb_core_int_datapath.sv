...
module tb_core_int_datapath;
  ...
  initial begin
    ...
    if (commit_count < 8 || alu_i_count < 3 || alu_r_count < 2 ||
        ...
        redirect_count < 3 || suppress_count < 8 || pc_count < 22) begin
      $fatal(1, "coverage goal missed");
    end

    $display("tb_core_int_datapath coverage: pass_count=%0d commit=%0d alu_i=%0d alu_r=%0d upper=%0d link=%0d branch=%0d redirect=%0d suppress=%0d pc=%0d",
