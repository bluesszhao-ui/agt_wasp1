...
implemented:
  ...
  SoC four-seed interrupt-heavy regression that reuses generated random_irq_stress OTP image
  SoC 32-seed nightly interrupt campaign with 384 non-overlapping schedule rounds
...
not yet implemented:
  ...
  multi-hour randomized software and interrupt-heavy soak campaigns
```
