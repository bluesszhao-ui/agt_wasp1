    ...
    diagrams = [
        ...
        (
            ...
            [
                ...
                Node("branch", 1010, 470, 220, 90, ("BRANCH", "TARGET"), GREEN),
                Node("redirect", 1300, 620, 220, 90, ("REDIRECT", "FLUSH"), PINK),
            ...
            ["SUPPORTED NOW: ALU LUI AUIPC BRANCH JAL JALR", "LOAD STORE CSR TRAP ARE STAGED LATER"],
        ),
        (
