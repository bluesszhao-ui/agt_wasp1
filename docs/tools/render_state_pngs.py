    ...
    diagrams = [
        ...
        (
            ...
            [
                ...
                Node("dmem", 1040, 640, 190, 80, ("DMEM", "REQ/RSP"), GREEN),
            ],
            [
            ...
            ["SUPPORTED NOW: ALU LUI AUIPC BRANCH JAL JALR LOAD STORE", "CSR TRAP INTERRUPT ARE STAGED LATER"],
        ),
        (
