...
| `core/core_int_datapath` | PASS | Executable integer datapath for ALU, LUI/AUIPC, branch/JAL/JALR redirect, and suppression paths passes |
...
```text
1. Integrate load/store requests and data return into the executable core datapath
```
