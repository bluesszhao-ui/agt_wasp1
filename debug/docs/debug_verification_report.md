...
| Top simulation end | `556ns` |
| Top self-check milestones | 25 |
...
| `466ns-506ns` | Issue unsupported Access Register size and clear cmderr | cmderr reports NOTSUP, then W1C clear returns it to zero | PASS |
| `506ns-556ns` | Pulse hart reset event and acknowledge havereset | dmstatus.havereset sets and clears | PASS |

## 4. Top Functional Coverage Summary

| Coverage item | Count | Result |
| --- | ---: | --- |
| Self-check milestones | 25 | PASS |
| DMI reads | 9 | PASS |
| DMI writes | 10 | PASS |
