...
![debug_abstract_cmd FSM](images/debug_abstract_cmd_fsm.png)

The L3 PNG is generated by `docs/tools/render_state_pngs.py` with separate
`SEQ`, `COMB`, and `IF` blocks.
