...
The JTAG TAP/DTM transport is not part of this module. A later `debug_jtag`
stage will translate JTAG DMI scans into the ready/valid `debug_dmi_if` used by
this module.
